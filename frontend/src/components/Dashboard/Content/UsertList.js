...
export default function UserList(language) {
  ...
  React.useEffect(() => {
    axios
    .get("https://univalleapp.herokuapp.comapi/user")
    .then(response => {
      setState({
        columns: [
          { title: window.app("Identification"), field: "id_user", editable: "onAdd", type: "numeric" },
          ...
          onRowAdd: newData =>
            new Promise(resolve => {
              setTimeout(() => {
                ...
                axios
                  .post("https://univalleapp.herokuapp.comapi/register/", {
          ...
          onRowUpdate: (newData, oldData) =>
            new Promise(resolve => {
              setTimeout(() => {
                ...
                axios
                  .patch(
                    "https://univalleapp.herokuapp.comapi/user/update/" + oldData.id_user,
                    {
                      id_user: newData.id_user,
                      name: newData.name,
                      last_name: newData.last_name,
