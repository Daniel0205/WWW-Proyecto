...
function Substation(props) {
  ...
  function consultSubstation(){
    axios
    .get(
      "https://univalleapp.herokuapp.comapi/substation"
    )
    .then(response => {
  ...
  function update(x){
    ...
    axios
    .put(
      "https://univalleapp.herokuapp.comapi/substation/update/"+x.id_substation,
      {
        sector_name: x.sector_name,
        lat_substation: x.lat_substation,
        long_substation: x.long_substation,
  ...
  function create(x) {
    axios
    .post(
      "https://univalleapp.herokuapp.comapi/substation/create/",
      {
        sector_name: x.sector_name,
        lat_substation: x.lat_substation,
        long_substation: x.long_substation,
